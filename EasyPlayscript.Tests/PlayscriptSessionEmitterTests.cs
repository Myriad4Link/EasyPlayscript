...
public class PlayscriptSessionEmitterTests
{
    ...
    {
        var code = PlayscriptSessionEmitter.Generate(EmptyScripts, EmptyTexts);
    ...
    public void Generate_WithScripts_HasGetScriptOverride()
    {
        ...
        var code = PlayscriptSessionEmitter.Generate(scripts, EmptyTexts);
    ...
    public void Generate_WithTexts_HasGetTextOverride()
    {
        ...
        var code = PlayscriptSessionEmitter.Generate(EmptyScripts, texts);
